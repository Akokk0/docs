import{_ as a,k as s,j as n,m as e}from"./chunks/framework.AigzJ4cd.js";const m=JSON.parse('{"title":"公网部署","description":"","frontmatter":{},"headers":[],"relativePath":"zh-CN/manual/recipe/server.md","filePath":"zh-CN/manual/recipe/server.md"}'),p={name:"zh-CN/manual/recipe/server.md"},r=e(`<h1 id="公网部署" tabindex="-1">公网部署 <a class="header-anchor" href="#公网部署" aria-label="Permalink to &quot;公网部署&quot;">​</a></h1><div class="warning custom-block"><p class="custom-block-title">WARNING</p><p>将 Koishi 暴露在公网上可能会导致你的服务器受到攻击。你需要妥善配合 <a href="./../usage/platform.html#控制台登录">用户登录</a> 等方式以限制控制台功能的访问能力。</p></div><p>Koishi 应用默认情况下只能在本机访问。而对于某些需求，你可能希望在公网上访问到 Koishi 的控制台或其他网络服务：</p><ul><li>让更多人访问到你的 Koishi 控制台</li><li>使用作为 webhook 服务端的插件 (例如 <a href="https://github.koishi.chat" target="_blank" rel="noreferrer">github</a> 和部分适配器插件)</li></ul><p>本节教程将指导你完成 Koishi 应用的公网部署。</p><h2 id="配置-server-插件" tabindex="-1">配置 server 插件 <a class="header-anchor" href="#配置-server-插件" aria-label="Permalink to &quot;配置 server 插件&quot;">​</a></h2><p><a href="./../../plugins/develop/server.html">@koishijs/plugin-server</a> 是一个预装插件。</p><p>前往「插件配置」页面，找到 server 插件，并将 <code>host</code> 修改为 <code>0.0.0.0</code>，随后点击右上角的「重载配置」。等待插件重启之后，你就可以使用 <code>IP:端口</code> 的方式，在局域网内任意设备的浏览器上访问到 Koishi 控制台了。</p><p>如果你已经准备了域名，你还需要同时将 <code>selfUrl</code> 修改为能访问到 Koishi 实例的地址。</p><h2 id="配置反向代理" tabindex="-1">配置反向代理 <a class="header-anchor" href="#配置反向代理" aria-label="Permalink to &quot;配置反向代理&quot;">​</a></h2><p>如果你有更复杂的需求，例如配置 SSL、域名等，可以使用反向代理。常见的方案有 nginx、Caddy 等。使用反向代理时，你不需要修改上述 <code>host</code> 配置项。</p><h3 id="使用-caddy" tabindex="-1">使用 Caddy <a class="header-anchor" href="#使用-caddy" aria-label="Permalink to &quot;使用 Caddy&quot;">​</a></h3><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span># 如果你希望使用域名，并自动签发 SSL 证书，请将下方 :80 改为你的域名</span></span>
